import getDetail from './data/detailApi.js';
...
if (data.message) {
  titleEl.innerHTML = data.message;
} else {
  ...
  coverImageEl.src = (data.coverImage) ? data.coverImage : 'assets/noimg.png';
  coverImageEl.className = 'block rounded-lg h-80 w-80 object-cover';
  titleEl.innerHTML = (data.title.romaji) ? data.title.romaji : 'Judul Mengalami Kendala';
  bannerImageEl.src = (data.bannerImage) ? data.bannerImage : 'assets/noimg.png';
  ...
  if (data.streamingEpisodes.length) {
    ...
    <div class="max-w-sm bg-white flex flex-col justify-between border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mb-10">
      <a href="${episode.url}">
        <img class="w-full rounded-t-lg" src="${episode.thumbnail}" alt="" />
      </a>
      <div class="p-5">
        <a href="${episode.url}">
  ...
  <div class="max-w-lg bg-white flex flex-col justify-between border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mb-10">
    <a href="https://www.youtube.com/watch?v=${data.trailer.id}">
      <img class="rounded-t-lg w-full" src="${data.trailer.thumbnail}" alt="" />
    </a>
    <div class="p-5">
      <a href="https://www.youtube.com/watch?v=${data.trailer.id}">
